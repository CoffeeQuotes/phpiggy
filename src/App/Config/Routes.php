...
use App\Middleware\GuestOnlyMiddleware as MiddlewareGuestOnlyMiddleware;
...
function registerRoutes(App $app)
{
    ...
    /* $app->get('/transaction/list', [TransactionController::class, 'list'])->add(AuthRequiredMiddleware::class); */
}
